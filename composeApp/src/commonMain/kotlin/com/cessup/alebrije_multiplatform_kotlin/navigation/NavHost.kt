package com.cessup.alebrije_multiplatform_kotlin.navigation
...
import com.cessup.alebrije_multiplatform_kotlin.ui.session.ForgotScreen
import com.cessup.alebrije_multiplatform_kotlin.ui.session.SignInScreen
import com.cessup.alebrije_multiplatform_kotlin.ui.session.SignUpScreen
...
fun NavGraphBuilder.generalNavGraph(navController: NavController) {
    navigation(
        ...
        composable(
            ...
            val error = route.substringAfter("${GeneralGraph.DataShare.ERROR_VALUE.name}=", "")
...
fun NavGraphBuilder.homeNavGraph(navController: NavController) {
    navigation(
        ...
        composable(
            ...
            val route = backStackEntry.destination.route ?: ""
            val token = route.substringAfter("${HomeGraph.DataShare.TOKEN_VALUE.name}=", "")
